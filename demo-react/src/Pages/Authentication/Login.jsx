            ...
            <div className="my-12">
                <form onSubmit={handleUserLogin} className="md:w-3/4 mx-auto">
                    ...
                    <div className="flex mt-6 flex-col items-center text-white">
                        <p className="mb-2 text-base font-medium">Dont Have Any Account?<Link to="/register"><span className="text-[#FFE72F] underline font-bold"> Click Here to Register!</span></Link></p>
                        {/* The "or" portion*/}
                        <div>
                        ...
                        <Link to="/ocr">
                            <div className="flex flex-row gap-4 my-2 w-72 items-center px-4 py-2 rounded-l-full rounded-r-full border border-solid border-[#FFE72F]" style={{ cursor: 'pointer' }}>
                                {/* <img src="https://img.icons8.com/color/48/000000/google-logo.png" alt="google" className="w-8 h-8"/> */}
                                <p className="text-base font-medium">Continue with Your NID/ Driver License</p>              
                            </div>
                        </Link>
                    </div>     
                </form>
